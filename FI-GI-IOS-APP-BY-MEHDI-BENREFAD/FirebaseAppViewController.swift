//
//  FirebaseAppViewController.swift
//  FI-GI-IOS-APP-BY-MEHDI-BENREFAD
//
//  Created by Mehdi Benrefad on 24/06/2021.
...
class FirebaseAppViewController: UIViewController , UITableViewDelegate , UITableViewDataSource{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "SegueToEdit"{
            let editViewController = segue.destination as! FirebaseAppViewController
