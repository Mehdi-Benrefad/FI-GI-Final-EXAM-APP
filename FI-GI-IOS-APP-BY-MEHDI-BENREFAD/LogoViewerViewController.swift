//
//  LogoViewerViewController.swift
//  FI-GI-IOS-APP-BY-MEHDI-BENREFAD
//
//  Created by Mehdi Benrefad on 21/06/2021.
//  Copyright © 2021 Mehdi Benrefad. All rights reserved.
//

import UIKit

class LogoViewerViewController: UIViewController {
    ...
    @IBAction func onSwipe(_ sender: UISwipeGestureRecognizer) {
        if sender.state == .ended {
                   print("hello")
        self.performSegue(withIdentifier: "logoViewerToSideMenu", sender: nil)
        }
    }
}
